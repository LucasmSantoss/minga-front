...
export default function Reaction() {
    ...
    useEffect(() => { 
        let url = "https://minga-grupoblanco.onrender.com/api/reactions?me=1&manga_id=" + mangaId
    ...
    function handleLike() {
        ...
        let url = 'https://minga-grupoblanco.onrender.com/api/reactions'
        let data = {
            manga_id: mangaId,
            name: "like"
        }
    ...
    useEffect( () => {
        axios.get("https://minga-grupoblanco.onrender.com/api/chapters/" + mangaId).then(res => setCantChapters(res.data.chapters.length))
    },[cantChapters])
