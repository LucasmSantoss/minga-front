...
export default function CreateManga() {
    ...
    async function handleSubmit(e) {
        ...
        const url = 'https://minga-grupoblanco.onrender.com/api/manga'
        try {
    ...
    async function renderCategory() {
        await axios.get('https://minga-grupoblanco.onrender.com/api/manga').then((response) => { setCategorias(response.data.categories) })
    }
